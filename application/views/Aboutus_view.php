        ...
        <div class="container">
            ...
            <div class="about-tp">
                <div class="col-md-8 about-agileits-w3layouts-left">
                    <iframe width="853" height="480" src="https://www.youtube.com/embed/uNqFbEng7_A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-md-4 about-agileits-w3layouts-right">
                    ...
                    <h4>Dairy farming</h4>
                    <p>No.1 Leading Dairy Farming marketplace with over 100 Products</p>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
