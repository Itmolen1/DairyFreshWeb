            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="contact_form">
                        ...
                        ?>
                        <form action="<?php echo base_url().'register/add'; ?>" id="registrationform" class="row" name="registrationform" method="post">
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="email" name="tbl_user_email" id="tbl_user_email" class="form-control" placeholder="Your Email" required="required" onKeyDown="if(event.keyCode === 32) return false;">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                                    <button type="submit" value="submit" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block" style="
    background-color: #683B26;">Register</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
