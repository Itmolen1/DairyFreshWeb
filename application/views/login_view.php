            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="contact_form">
                        <div id="message"></div>
                        <?php
                        echo form_open('http://soordairyfresh.com/login/getlogin','id="loginform" class="row" name="loginform" method="post"'); 
                        ?>
                            <fieldset class="row-fluid">
                                <fieldset class="row-fluid">
                                    <label for="username" class="lead">User Name</label>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" name="username" id="username" class="form-control" placeholder="your username" required="required" maxlength="30" onKeyDown="if(event.keyCode === 32) return false;">
                                    </div>
                                </fieldset>
                                <fieldset class="row-fluid">
    ...
    background-color: #683B26;">Login</button>
                                </div>
