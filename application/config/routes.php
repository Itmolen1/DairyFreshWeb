...
$route['Pd/(:any)'] = 'Pd';
$route['Pd/soorsearch/(:any)'] = 'Pd/soorsearch';

$route['OrderDetail/(:any)'] = 'OrderDetail';
$route['OrderDetail/List'] = 'OrderDetail/List';
...
$route['privacy_policy'] = "Detail_page/privacy_policy";
