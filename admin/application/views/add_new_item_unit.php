            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Item Unit Details</h3>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="item_unit_name">Unit Name</label>
                                        <input type="text" class="form-control required" value="<?php echo isset($list['item_unit_name']) ? $list['item_unit_name'] : ""; ?>" id="item_unit_name" name="item_unit_name" maxlength="200" tabindex="2" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))">
                                    </div>
                                    <?php 
                                        if(isset($record_num))
                                        {
