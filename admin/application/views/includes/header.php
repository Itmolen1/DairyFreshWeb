            ...
            <ul class="sidebar-menu" data-widget="tree">
               ...
               <?php 
                  ...
                  $record_num = $this->uri->segment($last);
                   ...
                   if($record_num=='vendor_listing' || $record_num=='item_master_listing' || $record_num=='item_unit_listing' || $record_num=='vehicle_listing' || $record_num=='time_slot_listing' || $record_num=='item_category_listing' || $record_num=='module_master_listing' || $record_num=='role_master_listing' || $record_num=='property_type_listing')
                   {
                     $flag=1;
                   }
                  ...
                  if(isset($alldata['role']) || $alldata['role']!=1)
                  {
                     ...
                     <li class="<?php if($flag==1){ echo 'treeview active menu-open'; } else echo 'treeview'; ?>" style="height: auto;">
                        ...
                        $this->session->userdata['myfinal']['property_type_listing']['p_update']==1 ||
                        isset($this->session->userdata['myfinal']['property_type_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['property_type_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>
                           
                           <li><a href="<?php echo base_url(); ?>property_type_listing"><i class="fa fa-home"></i>Property Type</a></li>
                     ...
                     if(isset($this->session->userdata['myfinal']['order_listing']['p_view']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_view']==1 ||
                        isset($this->session->userdata['myfinal']['order_listing']['p_add']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_add']==1 ||
                        isset($this->session->userdata['myfinal']['order_listing']['p_update']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_update']==1 ||
                        isset($this->session->userdata['myfinal']['order_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_delete']==1 || 
                        $this->session->userdata['role']==1)
                     {
                     ...
                     <li class="<?php if($flag==3){ echo 'treeview active menu-open'; } else echo 'treeview'; ?>" style="height: auto;">
                        <a href="#">
                        <i class="fa fa-bullseye"></i><span>Order List</span>
                        <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                        </span>
                        </a>
                        ...
                        $this->session->userdata['myfinal']['sub_service_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>
                           ...
                           <li><a href="<?php echo base_url(); ?>sub_service_listing"><i class="fa fa-list-alt"></i>Sub Services</a></li>
                           	...
                           	<?php } */ if(isset($this->session->userdata['myfinal']['order_listing']['p_add']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_add']==1 ||
                        isset($this->session->userdata['myfinal']['order_listing']['p_update']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_update']==1 ||
                        isset($this->session->userdata['myfinal']['order_listing']['p_delete']) && 
                        $this->session->userdata['myfinal']['order_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>
                           
                           <li><a href="<?php echo base_url(); ?>order_listing"><i class="fa fa-truck"></i>Orders</a></li>
                     ...
                     <li class="<?php if($flag==5){ echo 'treeview active menu-open'; } else echo 'treeview'; ?>" style="height: auto;">
                        ...
                        $this->session->userdata['myfinal']['purchase_master_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>
                           ...
                           <li><a href="<?php echo base_url(); ?>purchase_master_listing"><i class="fa fa-credit-card"></i>Purchase Master</a></li>                              
                     ...
                     <li class="<?php if($flag==6){ echo 'treeview active menu-open'; } else echo 'treeview'; ?>" style="height: auto;">
                        ...
                        $this->session->userdata['myfinal']['sales_master_listing']['p_delete']==1 || $this->session->userdata['role']==1) { ?>
                           ...
                           <li><a href="<?php echo base_url(); ?>sales_master_listing"><i class="fa fa-credit-card"></i>Sales</a></li>                              
