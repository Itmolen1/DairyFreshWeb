                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="add_new_item_unit" action="<?php echo base_url().$action?>" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo isset($list['item_master_stock']) ? $list['item_master_stock'] : ""; ?>" id="item_master_stock" name="item_master_stock" maxlength="200" tabindex="2" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo isset($list['item_master_price']) ? $list['item_master_price'] : ""; ?>" id="item_master_price" name="item_master_price" maxlength="200" tabindex="2" onkeypress="return ((event.charCode >= 48 && event.charCode <= 57))">
                                    </div>
                                </div>   
                            </div>
                            ...
                            <div class="row">
                                <textarea class="ckeditor input" id="item_master_desc" name="item_master_desc"><?php echo isset($list['item_master_desc']) ? $list['item_master_desc'] : ""; ?></textarea>
                            </div>
