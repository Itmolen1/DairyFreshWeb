                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><a data-fancybox="gallery" href="<?php echo $record->item_category_logo; ?>"><img class="image-link" height="100" width="100" src="<?php echo $record->item_category_logo; ?>"></a></td>
