...
class Contact_us_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.id,BaseTbl.name,BaseTbl.email,BaseTbl.mobile_number,BaseTbl.comments,BaseTbl.created_at');
    ...
    {
        $this->db->select('BaseTbl.id,BaseTbl.name,BaseTbl.email,BaseTbl.mobile_number,BaseTbl.comments,BaseTbl.created_at,BaseTbl.status');
        $this->db->from('tbl_contact_us as BaseTbl');
        if(!empty($searchText)) {
            $likeCriteria = "(BaseTbl.email  LIKE '%".$searchText."%'
                            OR  BaseTbl.name  LIKE '%".$searchText."%'
