...
class Item_category_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.item_category_id, BaseTbl.item_category_name, BaseTbl.item_category_created_at, BaseTbl.item_category_updated_at,BaseTbl.item_category_logo');
    ...
    {
        $this->db->set('item_category_name',trim(str_replace(' ', '-',$val['item_category_name'])));
        $this->db->set('item_category_updated_at',date('Y-m-d H:i:s'));
        $this->db->set('item_category_logo',$val['item_category_logo']);
