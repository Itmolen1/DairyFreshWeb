...
class Item_master_model extends CI_Model
{
    ...
    function add_new_item_master($value)
    {
        ...
        $vals = array('item_master_name'=>trim($value['item_master_name']),'item_master_url_slug'=>$item_master_url_slug,'item_master_desc'=>$value['item_master_desc'],'item_master_stock'=>$value['item_master_stock'],'item_master_price'=>$value['item_master_price'],'item_master_unit'=>$value['item_master_unit'],'item_master_created_at'=>date('Y-m-d H:i:s'),'item_master_update_at'=>date('Y-m-d H:i:s'),'item_master_logo'=>$value['item_master_logo'],'item_master_category'=>$value['item_master_category']);
        $this->db->trans_start();
