...
$route['servicesListing/servicesListing'] = 'Services/servicesListing';
...
$route['sub_service_listing/sub_service_listing'] = 'sub_services/sub_service_listing';
...
$route['contact_us_listing/contact_us_listing'] = 'contact_us/contact_us_listing';
...
$route['careers_listing/careers_listing'] = 'Careers/careers_listing';
...
$route['partner_listing/partner_listing'] = 'Partner/partner_listing';
$route['careers_listing/(:num)'] = "Careers/careers_listing/$1";
//$route['contact_us_reply/(:num)'] = 'Careers/contact_us_reply/$1';
//$route['contact_us_reply'] = 'Careers/contact_us_reply';
...
$route['sliderListing/sliderListing'] = 'Slider/sliderListing';
...
$route['order_listing/order_listing'] = 'order/order_listing';
$route['edit_order/(:num)'] = "order/edit_order/$1";
...
$route['track_service_request/(:num)'] = "order/track_service_request/$1";
$route['get_latest_cordinates'] = "order/get_latest_cordinates";
$route['detailed_status_service_request/(:num)'] = "order/detailed_status_service_request/$1";
$route['get_suborder_details'] = "order/get_suborder_details";
$route['sr_admin_accept/(:num)'] = "order/sr_admin_accept/$1";
$route['sr_admin_reject/(:num)'] = "order/sr_admin_reject/$1";

//guest service request
$route['guest_service_request_listing'] = 'guest_service_request/guest_service_request_listing';
$route['guest_service_request_listing/guest_service_request_listing'] = 'guest_service_request/guest_service_request_listing';
...
$route['employee_listing/employee_listing'] = 'employee/employee_listing';
...
$route['emp_order_history/(:num)'] = "employee/emp_order_history/$1";

//item unit
$route['item_unit_listing'] = 'item_unit/item_unit_listing';
$route['item_unit_listing/item_unit_listing'] = 'item_unit/item_unit_listing';
...
$route['item_unit_import'] = "item_unit/item_unit_import";
...
$route['time_slot_listing/time_slot_listing'] = 'time_slot/time_slot_listing';
...
$route['r_user_listing/r_user_listing'] = 'r_user/r_user_listing';
...
$route['guest_user_listing/guest_user_listing'] = 'guest_user/guest_user_listing';
...
$route['vehicle_listing/vehicle_listing'] = 'vehicle/vehicle_listing';
...
$route['purchase_order_listing/purchase_order_listing'] = 'purchase_order/purchase_order_listing';
$route['purchase_order_listing/(:num)'] = 'purchase_order/purchase_order_listing/$1';
...
$route['purchase_master_listing/purchase_master_listing'] = 'purchase_master/purchase_master_listing';
$route['purchase_master_listing/(:num)'] = "purchase_master/purchase_master_listing/$1";
...
$route['sales_quotation_listing/sales_quotation_listing'] = 'sales_quotation/sales_quotation_listing';
$route['sales_quotation_listing/(:num)'] = 'sales_quotation/sales_quotation_listing/$1';
...
$route['sales_master_listing/sales_master_listing'] = 'sales_master/sales_master_listing';
$route['sales_master_listing/(:num)'] = "sales_master/sales_master_listing/$1";
// rights and roles
...
$route['contact_listing/contact_listing'] = 'Contact/contact_listing';
...
// AMC
$route['amc_listing'] = 'amc/amc_listing';
$route['amc_listing/amc_listing'] = 'amc/amc_listing';
$route['amc_listing/(:num)'] = 'amc/amc_listing/$1';
$route['add_new_amc'] = 'amc/add_new_amc';
$route['add_amc_boi_session'] = 'amc/add_amc_boi_session';
$route['delete_amc_boi_session'] = 'amc/delete_amc_boi_session';
$route['delete_amc/(:num)'] = 'amc/delete_amc/$1';
$route['edit_amc/(:num)'] = "amc/edit_amc/$1";
$route['edit_amc'] = "amc/edit_amc";
$route['edit_amc_boi_session'] = "amc/edit_amc_boi_session";
$route['amc_get_qr_pdf'] = "amc/amc_get_qr_pdf";
$route['amc_get_pdf'] = "amc/amc_get_pdf";
$route['purchase_order_email'] = "amc/purchase_order_email";
$route['amc_get_qr'] = "amc/amc_get_qr";

//AMC content
$route['amc_content_listing'] = 'Amc_content/amc_content_listing';
$route['amc_content_listing/(:num)'] = "Amc_content/amc_content_listing/$1";
$route['add_new_amc_content'] = "Amc_content/add_new_amc_content";
$route['delete_amc_content/(:num)'] = "Amc_content/delete_amc_content/$1";
$route['edit_amc_content/(:num)'] = "Amc_content/edit_amc_content/$1";
$route['edit_amc_content'] = "Amc_content/edit_amc_content";
//Reports
